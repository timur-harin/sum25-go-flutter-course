...
// New tasks have status Done = false
...
// UpdateTask updates an existing task, returns error if title is empty or when task with this id not found
...
func (tm *TaskManager) DeleteTask(id int) error {
	// Check the existence of the task before deleting it
