...
class ApiService {
    ...
    try {
      ...
      return _handleResponse(
          ...
          (data) => ((data["data"] as List)
              .map((value) => Message.fromJson(value))).toList());
    ...
    try {
      if (request.validate() == null) {
        ...
        final response = await _client
            ...
            .timeout(timeout);
        final finalResponse = _handleResponse(
            response,
            (data) =>
                ApiResponse.fromJson(data, (json) => Message.fromJson(json)));
        return finalResponse.data!;
      }
    } on TimeoutException catch (_) {
      throw TimeoutException("Timeout");
    }
    throw ServerException('Failed to create message');
  }
  ...
  Future<HTTPStatusResponse> getHTTPStatus(int statusCode) async {
    ...
    final response =
        await _client.get(Uri.parse("$baseUrl/api/status/$statusCode"));
    final finalResponse = _handleResponse(
      response,
