...
class Message {
  ...
  Message({
    required this.id, required this.username, required this.content, required this.timestamp,
  });
...
class HTTPStatusResponse {
  ...
  HTTPStatusResponse({
    required this.statusCode, required this.imageUrl, required this.description
  });
  // TODO: Add factory constructor fromJson(Map<String, dynamic> json)
