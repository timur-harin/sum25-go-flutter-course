              ...
              TextButton(
                  onPressed: () async {
                    ...
                    UpdateMessageRequest updateMessageRequest =
                        UpdateMessageRequest(content: controller.text);
                    Message newMessage = await _apiService.updateMessage(
                        message.id, updateMessageRequest);
                    int index =
  ...
  Widget _buildMessageTile(Message message) {
    return ListTile(
        ...
        onTap: () async {
          ...
          int randomStatusCode =
              statusCodes[random.nextInt(statusCodes.length)];
        ...
        builder: (context) {
          return AlertDialog(
            actions: [
              ...
              TextButton(onPressed: () {}, child: const Text("200")),
              TextButton(onPressed: () {}, child: const Text("201")),
              TextButton(onPressed: () {}, child: const Text("400")),
              TextButton(onPressed: () {}, child: const Text("401")),
              TextButton(onPressed: () {}, child: const Text("403")),
              TextButton(onPressed: () {}, child: const Text("404")),
              TextButton(onPressed: () {}, child: const Text("418")),
              TextButton(onPressed: () {}, child: const Text("500")),
              TextButton(
                  onPressed: () async {
                    HTTPStatusResponse httpStatusResponse =
                        await apiService.getHTTPStatus(503);
