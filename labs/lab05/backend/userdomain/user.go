...
func ValidateEmail(email string) error {
	...
	regEmail := regexp.MustCompile(pattern)
	isMatch := regEmail.MatchString(email)
...
func ValidatePassword(password string) error {
	...
	for _, i := range password {
		hasUppercase = hasUppercase || unicode.IsUpper(i)
		hasLowercase = hasLowercase || unicode.IsLower(i)
		hasNumber = hasNumber || unicode.IsDigit(i)
	}
