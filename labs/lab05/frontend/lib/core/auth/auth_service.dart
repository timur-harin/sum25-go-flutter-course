...
class AuthService {
  ...
  Future<AuthResult> login(String email, String password) async {
    ...
    final passwordError = FormValidator.validatePassword(sanitizedPassword);
    ...
    // Verify password
    final passwordValid = await _userRepository.verifyPassword(sanitizedEmail, sanitizedPassword);
    if (!passwordValid) {
      return AuthResult.invalidCredentials;
    }
