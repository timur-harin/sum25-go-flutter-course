...
class AuthService {
  ...
  // Session validation method implementation
  bool isSessionValid() {
  ...
  // Refresh authentication method implementation
  Future<bool> refreshAuth() async {
    try {
      ...
      if (_currentState.token != null) {
        final isTokenValid = _jwtService.validateToken(_currentState.token!);
        if (!isTokenValid) {
          await logout();
          return false;
        }
  ...
  // Get user info method implementation
