...
class AuthService {
  ...
  try {
    ...
    final isCorrect = await _userRepository.verifyPassword(sanitizedEmail, password);
    if (!isCorrect) return AuthResult.invalidCredentials;
...
class _MockUserRepository implements UserRepositoryInterface {
  ...
  Future<User?> findByEmail(String email) async {
    ...
    final userData = _users[email.trim()];
