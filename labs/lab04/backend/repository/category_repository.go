...
// SearchCategories by name with LIKE
...
// GetCategoriesWithPosts loads categories with their posts
...
// CreateWithTransaction creates multiple categories in one transaction
