...
// Validate checks if Post fields are valid
...
// Validate checks if CreatePostRequest fields are valid
...
// ToPost converts CreatePostRequest into Post with timestamps
...
// ScanRow scans a single *sql.Row into a Post
